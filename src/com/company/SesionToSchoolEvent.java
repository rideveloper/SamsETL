...
public class SesionToSchoolEvent {
        ...
        try
        {
            ...
            PreparedStatement retrieveOldData = connection_old_db.prepareStatement
                    ("SELECT FirstTermstartDate,firstTermendDate,schoolCode,secondTermendDate,secondTermstartDate,thirdTermendDate,thirdTermstartDate," +
                                    " FirstTermHolidayendDate,FirstTermHolidaystartDate,FirstTermMidTermendDate,FirstTermMidTermstartDate,secondTermHolidayendDate," +
                                    "secondTermHolidaystartDate,secondTermMidTermendDate,secondTermMidTermstartDate,thirdTermHolidayendDate,thirdTermHolidaystartDate," +
                                    "thirdTermMidTermendDate,thirdTermMidTermstartDate"
                ...
                for (int i = 0; i <= 8; i++) {
                    ...
                    switch (i) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            insertNewData.setString(4, "First Term Holiday");
                            insertNewData.setDate(5, formatDate(retrieveOldDataRS.getString("FirstTermHolidayendDate")));
                            insertNewData.setDate(6, formatDate(retrieveOldDataRS.getString("FirstTermHolidaystartDate")));
                            insertNewData.setString(7, "First Term Holiday");
                            insertNewData.setInt(8, 5);
                            break;
                        case 4:
                            insertNewData.setString(4, "First MidTerm");
                            insertNewData.setDate(5, formatDate(retrieveOldDataRS.getString("FirstTermMidTermendDate")));
                            insertNewData.setDate(6, formatDate(retrieveOldDataRS.getString("FirstTermMidTermstartDate")));
                            insertNewData.setString(7, "First MidTerm");
                            insertNewData.setInt(8, 4);
                            break;
                        case 5:
                            insertNewData.setString(4, "Second Term Holiday");
                            insertNewData.setDate(5, formatDate(retrieveOldDataRS.getString("secondTermHolidayendDate")));
                            insertNewData.setDate(6, formatDate(retrieveOldDataRS.getString("secondTermHolidaystartDate")));
                            insertNewData.setString(7, "Second Term Holiday");
                            insertNewData.setInt(8, 5);
                            break;
                        case 6:
                            insertNewData.setString(4, "Second MidTerm");
                            insertNewData.setDate(5, formatDate(retrieveOldDataRS.getString("secondTermMidTermendDate")));
                            insertNewData.setDate(6, formatDate(retrieveOldDataRS.getString("secondTermMidTermstartDate")));
                            insertNewData.setString(7, "Second MidTerm");
                            insertNewData.setInt(8, 4);
                            break;
                        case 7:
                            insertNewData.setString(4, "Third Term Holiday");
                            insertNewData.setDate(5, formatDate(retrieveOldDataRS.getString("thirdTermHolidaystartDate")));
                            insertNewData.setDate(6, formatDate(retrieveOldDataRS.getString("thirdTermHolidayendDate")));
                            insertNewData.setString(7, "Third Term Holiday");
                            insertNewData.setInt(8, 5);
                            break;
                        case 8:
                            insertNewData.setString(4, "Third MidTerm");
                            insertNewData.setDate(5, formatDate(retrieveOldDataRS.getString("thirdTermMidTermendDate")));
                            insertNewData.setDate(6, formatDate(retrieveOldDataRS.getString("thirdTermMidTermstartDate")));
                            insertNewData.setString(7, "Third MidTerm");
                            insertNewData.setInt(8, 4);
                            break;
                    }
